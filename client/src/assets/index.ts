import wellfound from "./platforms/wellfound.png";
import linkedin from "./platforms/linkedin.svg";
...
const magicIcon: HTMLImageElement = document.createElement("img");
// magicIcon.className = 'w-10 h-10 float-right cursor-pointer'
magicIcon.src = generateIcon;
magicIcon.id = "generateIcon";
magicIcon.alt = "generate icon";
magicIcon.style.width = "32px";
magicIcon.style.height = "32px";
magicIcon.style.position = "relative";
magicIcon.style.bottom = "40px";
magicIcon.style.cursor = "pointer";
