    ...
    <section className="space-y-4 bg-white/40 backdrop-blur-sm rounded-xl p-4 border border-white/30 shadow-lg">
      <div className="flex justify-between items-center">
        ...
        <button
          ...
          className="px-2 py-2 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors duration-200 flex items-center gap-2"
        >
      ...
      {fields.length > 0 && (
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div className="">
            <div>
              <h4 className="text-sm text-left flex font-medium text-yellow-800">
              ...
              <ul className="text-xs text-left text-yellow-700 mt-1 space-y-1">
